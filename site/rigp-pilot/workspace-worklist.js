...
function opsQueueCounts(){
  ...
  return {mine,free,fresh,evidence,due};
}
...
function worklistToolbar(){
  ...
  const buttons=[['ALL','Todas',TASKS.length],['MINE','Mías',c.mine],['FREE','Libres',c.free],['NEW_INFO','Nueva info',c.fresh],['EVIDENCE','Evidencia',c.evidence],['DUE','Por vencer',c.due]];
